...
class VariationalPosterior:
    ...
    def whiten(
        ...
        __, vp_Sigma = self.moments(origflag=False, covflag=True)
        ...
        if type(options["warpcovreg"]) == float or type(options["warpcovreg"]) == int:
            ...
            w_reg = options.warpcovreg[vbmc.optim_state["N"]]
        ...
        # Not needed, shared object (I think):
        ...
        if vbmc.optim_state.get("search_cache"):
