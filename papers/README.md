...
| `huggins2023pyvbmc` | Huggins B, Li C, Tobaben M, Aarnos MJ & Acerbi L (2023). *PyVBMC: Efficient Bayesian inference in Python.* Journal of Open Source Software 8(86):5428. | The software paper for this package: scope, features, and the differences from the MATLAB implementation. |
