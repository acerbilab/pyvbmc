# Noisy-target acquisitions: profiles, prototypes and same-machine arms

Detailed report behind the [summary note](../2026-09-08-noisy-acquisitions.md).
Branch `claude/pyvbmc-noisy-acq-funcs-9kwdny`; container with four cores,
one BLAS thread per process; 2026-09-08/09. No default was changed. The
