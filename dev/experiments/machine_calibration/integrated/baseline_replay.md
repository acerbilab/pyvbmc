# Golden replay 2026-09-09 21:20

Code `f7f0ce1` (dirty); baseline `absent_old_traces`; threads 1; 3.5 min.
...
|---|---|---|---|---|---|---|---|---|---|
| normal_D5 | 0 | finals only; OUTSIDE envelope: gskl | - | - | 0.000307 → 0.019 (0.0249) | 0.000105 → 0.000491 (0.000429) | 0.00783 → 0.00775 (0.0121) | 70 → 70 [70, 85] | 0.35 → 0.4 |
| banana_D2 | 0 | finals only | - | - | 0.043 → 0.0314 (0.157) | 0.15 → 0.121 (0.561) | 0.0392 → 0.0346 (0.113) | 80 → 85 [70, 125] | 0.23 → 0.27 |
| halfnormal_D2 | 0 | finals only | - | - | 0.009 → 0.00807 (0.0173) | 0.000318 → 0.000116 (0.000748) | 0.0213 → 0.0221 (0.0274) | 65 → 65 [65, 75] | 0.17 → 0.2 |
| cigar_D4 | 0 | finals only | - | - | 0.00174 → 0.00492 (0.0324) | 0.000422 → 0.000825 (0.00676) | 0.0088 → 0.00908 (0.0249) | 130 → 140 [115, 170] | 0.78 → 1.1 |
| rosenbrock_D2_noise1 | 0 | finals only | - | - | 0.0267 → 0.00752 (0.49) | 0.0635 → 0.0101 (0.144) | 0.0455 → 0.02 (0.111) | 115 → 125 [100, 155] | 1.2 → 1.5 |
