...
def test_iteration_history_record_iteration():
    ...
    assert iteration_history.get("gp_samplevar")[iteration] == varss
    assert iteration_history.get("gp_N_samples")[iteration] == Ns_gp
    ...
    assert iteration_history.get("gp_N_samples")[iteration2] == Ns_gp
    assert iteration_history.get("gp_samplevar")[iteration2] == varss
